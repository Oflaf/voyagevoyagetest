...
const viewTransitionState = {
    isActive: false,        // Czy przejście jest aktywne
    phase: 'out',           // 'out' (ściemnianie), 'in' (rozjaśnianie)
    progress: 0,            // Postęp animacji (0.0 do 1.0)
    speed: 0.9,             // Szybkość przejścia (większa wartość = szybsze)
    targetView: 'cockpit'   // Do jakiego widoku przechodzimy
};
...
`;
    ...
    apply(mainCtx, glCtx) {
        ...
        const shaderGamma = 1.0 + (gammaLevel - 3) * 0.25;
...
const mirrorState = {
    ...
    damping: 0.48,     // Tłumienie (jak szybko przestaje się bujać)
...
// --- NOWY KOD: ŁADOWANIE GRAFIK SILNIKA (załóżmy, że są w folderze img/) ---
// --- NOWY KOD: ŁADOWANIE GRAFIK BAGAŻNIKA ---
assets.trunk.src = "img/trunk.png";

assets.lantern.src = "img/lantern.png"; // <--- DODAJ TĘ LINIĘ
assets.oilBase.src = "img/oilbase.png";
// --- KONIEC NOWEGO KODU ---
assets.beerBase.src = "img/beerbase.png";
assets.beer.src = "img/beer.png";

// --- NOWY KOD: ŁADOWANIE GRAFIK SILNIKA (załóżmy, że są w folderze img/) ---
assets.engineBack.src = "img/engineback.png";
assets.engineBody.src = "img/engine.png";
assets.oilCap.src = "img/oilcap.png";
assets.oilBottle.src = "img/oilbottle.png";
assets.oildrop.src = "img/oildrop.png"; // <-- DODAJ TĘ LINIĘ
// ...
// --- KONIEC NOWEGO KODU ---
assets.arm.src = "img/arm.png";
assets.road.src = "road.png";
assets.cockpit.src = "img/interior.png";
assets.cockpitBroken.src = "img/interiorbroken.png";
assets.steeringWheel.src = "img/steering_wheel.png";
assets.shifter.src = "img/shiffter.png";
assets.field.src = "img/field.webp"; 
assets.forest.src = "img/forest.png";
assets.backforest.src = "backforest.png";
assets.grassLeft = new Image();
assets.grassRight = new Image();
assets.grassLeft.src = "img/grass.webp";
assets.grassRight.src = "img/grass.webp";
assets.secondGrassLeft = new Image();
assets.secondGrassRight = new Image();
assets.secondGrassLeft.src = "img/secondgrass.webp";
assets.secondGrassRight.src = "img/secondgrass.webp";
assets.blades.src = "blades.png"; 
assets.dust.src = "dust.png"; 
assets.dust_blue.src = "dust_blue.png";
assets.hang.src = "hang.png";
assets.photo.src = "photo.png"; 
assets.carSign.src = "car_sign.png";
assets.sky.src = "img/sky.png";
assets.ground = new Image();
assets.ground.src = "img/ground.png"; 
assets.picket.src = "img/picket.png"; 
assets.pedalClutchBrake.src = "img/pedal1.png";
assets.pedalGas.src = "img/pedal2.png";
assets.pole.src = "img/pole.png";
assets.windowGlass.src = "img/window.png";
assets.windowButtonHandle1.src = "img/handle.png";
assets.windowButtonHandle2.src = "img/handle2.png";
assets.windowButton = assets.windowButtonHandle1;
assets.handleMirror.src = "img/handlemirror.png";
assets.button1.src = "img/controls/button1.png";
assets.button2.src = "img/controls/button2.png";
assets.interiorLight.src = "img/interiorlighten.png";
assets.bird1.src = "img/bird.png";
assets.bird2.src = "img/bird2.png";
assets.radio.src = "img/radio.png"; 
assets.wiper.src = "img/wiper.png";
assets.counterl.src = "img/controls/counterl.png";
assets.counterHud.src = "img/controls/counterhud.png";
assets.counterNeedle.src = "img/controls/counter_needle.png";
assets.mirror.src = "img/mirror1.png";
assets.mirror2.src = "img/mirror2.png";
assets.docObject.src = "img/doc.png";
assets.opponentBottom.src = "img/opponent_bottom.png";
assets.opponentTop.src = "img/opponent_top.png";
assets.c_cockpit.src = "img/c_cockpit.png";
assets.c_engine.src = "img/c_engine.png";
assets.c_trunk.src = "img/c_trunk.png";
assets.blinker.src = "img/blinker.png"; // <--- DODAJ TĘ LINIĘ
assets.wheelBase.src = "img/wheelbase.png";
assets.wheel.src = "img/wheel.png";

// Po załadowaniu, przypisz je do stanu menu
assets.c_trunk.onload = () => { // Używamy .onload ostatniego obrazka jako sygnału
...
// --- NOWY KOD: ŁADOWANIE OBRAZÓW DLA NAKŁADKI DOKUMENTU ---
// Upewnij się, że masz te pliki w folderze 'img/'
docOverlayImages.images[0].src = "img/document1.png";
docOverlayImages.images[1].src = "img/document2.png";

const oilDrops = []; // Tablica na aktywne cząsteczki kropelek oleju

// ZMIANA: Dodano 'lever2.png' do listy plików do załadowania
...
for (let i = 1; i <= 7; i++) { const img = new Image(); img.src = `img/Tree${i}.webp`; assets.treeImages.push(img); }
for (let i = 1; i <= 7; i++) { const img = new Image(); img.src = `img/tree${i}.webp`; assets.backgroundTreeImages.push(img); }
for (let i = 1; i <= 5; i++) { const img = new Image(); img.src = `img/building${i}.webp`; assets.buildingImages.push(img); }
const specialBuildingNames = ['a', 'b', 'c', 'd', 'e', 'f'];
for (const name of specialBuildingNames) { const img = new Image(); img.src = `img/building${name}.webp`; assets.specialBuildingImages.push(img); }
for (let i = 1; i <= 3; i++) { const img = new Image(); img.src = `img/field${i}.webp`; assets.fieldImages.push(img); }
...
carImageFiles.forEach(file => { const img = new Image(); img.src = `img/${file}`; assets.cars.push(img); });
...
function drawViewTransition() {
    // Jeśli przejście nie jest aktywne, nic nie rysuj
    if (!viewTransitionState.isActive) return;
...
window.addEventListener('load', () => { console.log("Strona załadowana, próbuję odtworzyć dźwięk testowo."); const testSound = audio.background; testSound.volume = 0.2; const promise = testSound.play(); if (promise !== undefined) { promise.then(_ => { console.log("Testowe odtwarzanie rozpoczęte pomyślnie!"); }).catch(error => { console.error("Testowe odtwarzanie nie powiodło się (prawdopodobnie wymaga interakcji użytkownika):", error); document.body.addEventListener('click', () => { console.log("Kliknięto, ponowna próba odtworzenia testowego dźwięku."); testSound.play(); }, { once: true }); }); } });
...
function updateTrees(speedKmH) { if (assets.treeImages.length === 0) return; const speedFactor = speedKmH / gameState.maxSpeedKmH; treeSpawner.nextSpawnDistance -= speedFactor * 80; if (treeSpawner.nextSpawnDistance <= 0) { const doesSway = Math.random() < 0.85; const newTree = { sliceIndex: gameState.roadsideMaxSlices, side: Math.random() < 0.5 ? "left" : "right", image: assets.treeImages[Math.floor(Math.random() * assets.treeImages.length)], sizeVariation: 0.3 + Math.random() * 1.2, sway: { frequency: doesSway ? 0.2 + Math.random() * 3.9 : 0, amplitude: doesSway ? 0.008 + Math.random() * 0.01 : 0, phase: Math.random() * Math.PI * 2 } }; roadsideObjects.trees.push(newTree); if (gameState.isInCity) { treeSpawner.nextSpawnDistance = 2500 + Math.random() * 4000; treeSpawner.inCluster = false; } else { if (treeSpawner.inCluster) { treeSpawner.nextSpawnDistance = 150 + Math.random() * 250; treeSpawner.clusterTreesRemaining--; if (treeSpawner.clusterTreesRemaining <= 0) treeSpawner.inCluster = false; } else { if (Math.random() < 0.45) { treeSpawner.inCluster = true; treeSpawner.clusterTreesRemaining = 3 + Math.floor(Math.random() * 10); treeSpawner.nextSpawnDistance = 100 + Math.random() * 200; } else { treeSpawner.nextSpawnDistance = 1500 + Math.random() * 2000; } } } } for (let i = roadsideObjects.trees.length - 1; i >= 0; i--) { const tree = roadsideObjects.trees[i]; const t = 1 - tree.sliceIndex / gameState.roadsideMaxSlices; const speedMultiplier = 0.10 + 79.4 * t; tree.sliceIndex -= speedFactor * speedMultiplier; if (tree.sliceIndex < -10) roadsideObjects.trees.splice(i, 1); } }
...
function updateMirror(deltaTime) {
    ...
    // --- POPRAWKA TUTAJ ---
    // Zmniejszyliśmy współczynnik animacji z 0.8 na 0.15, aby przejście było widoczne.
...
canvas.addEventListener("click", (e) => {
    // Usunęliśmy stąd logikę picia piwa, ponieważ jest teraz obsługiwana przez 'dblclick'.
...
function manageGameSounds() {
    ...
    if (currentView === 'cockpit') {
        ...
        if (controls.s && gameState.speedKmH > 0) {
            if (audio.unlocked && audio.breaking.paused) { stopAllEngineSounds(); audio.breaking.play().catch(console.warn); }
        }
...
function updateGameState(deltaTime) {
    ...
    // --- NOWA LOGIKA: Zatarcie silnika ---
    // Jeśli silnik jest zatarty, blokujemy większość aktualizacji i wymuszamy hamowanie
    if (gameState.engineSeized) {
        controls.w = false; // Odbieramy możliwość przyspieszania
        if (gameState.speedKmH > 0) {
            gameState.speedKmH -= gameState.decelerationKmH;
            gameState.speedKmH = Math.max(0, gameState.speedKmH);
        }
        // Pozwalamy na aktualizację tylko niektórych rzeczy, jak np. efekty wizualne
        updatePixelationEffect(deltaTime);
        updateHanger(deltaTime);
        updateControls(deltaTime);
        return; // Kończymy funkcję, aby nie aktualizować reszty logiki
    }
    // --- KONIEC NOWEJ LOGIKI ---
...
updateBlinkEffect(deltaTime); // <--- DODAJ TĘ LINIĘ TUTAJ
    ...
    if (currentView === 'cockpit') {
        ...
        drawHazardLights(); // Światła awaryjne
...
function drawHazardLights() {
    ...
    if (controlsState.hazardOn) {
        console.log(
            "Hazard ON. Blinker visible:", controlsState.blinkerVisible, 
            "Asset loaded:", assets.blinker.complete
        );
    }

    if (!controlsState.hazardOn || !controlsState.blinkerVisible || !assets.blinker || !assets.blinker.complete) {
        return;
    }
    ...
    ctx.save();
    // Ustawiamy lekką przezroczystość dla lepszego efektu
    ctx.globalAlpha = 0.85;

    // 2. Logika zależna od widoku
    if (currentView === 'cockpit') {
        // Dla kokpitu: dwa migacze za szybą
        // Współrzędne dobrane tak, aby wyglądały jakby były na zewnątrz, za słupkami A
        const cockpitLeftX = 450;
        const cockpitRightX = 1270;
        const cockpitY = 580;

        ctx.drawImage(assets.blinker, cockpitLeftX, cockpitY, blinkerWidth, blinkerHeight);
        ctx.drawImage(assets.blinker, cockpitRightX, cockpitY, blinkerWidth, blinkerHeight);

    } else if (currentView === 'trunk' || currentView === 'engine') {
        // Dla bagażnika i silnika: w dolnych rogach ekranu
        const cornerPaddingX = 10;
        const cornerPaddingY = 10; // Odstęp od dołu
        const cornerY = canvas.height - cornerPaddingY;

        // Lewy dolny róg
        ctx.drawImage(assets.blinker, cornerPaddingX, cornerY, blinkerWidth, blinkerHeight);
        // Prawy dolny róg
        ctx.drawImage(assets.blinker, canvas.width - cornerPaddingX - blinkerWidth, cornerY, blinkerWidth, blinkerHeight);
    }
