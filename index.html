...
// --- NOWY KOD: ŁADOWANIE GRAFIK SILNIKA (załóżmy, że są w folderze ) ---
// --- NOWY KOD: ŁADOWANIE GRAFIK BAGAŻNIKA ---
assets.trunk.src = "trunk.png";

assets.lantern.src = "lantern.png"; // <--- DODAJ TĘ LINIĘ
assets.oilBase.src = "oilbase.png";
// --- KONIEC NOWEGO KODU ---
assets.beerBase.src = "beerbase.png";
assets.beer.src = "beer.png";

// --- NOWY KOD: ŁADOWANIE GRAFIK SILNIKA (załóżmy, że są w folderze ) ---
assets.engineBack.src = "engineback.png";
assets.engineBody.src = "engine.png";
assets.oilCap.src = "oilcap.png";
assets.oilBottle.src = "oilbottle.png";
assets.oildrop.src = "oildrop.png"; // <-- DODAJ TĘ LINIĘ
// ...
// --- KONIEC NOWEGO KODU ---
assets.arm.src = "arm.png";
assets.road.src = "road.png";
assets.cockpit.src = "interior.png";
assets.cockpitBroken.src = "interiorbroken.png";
assets.steeringWheel.src = "steering_wheel.png";
assets.shifter.src = "shiffter.png";
assets.field.src = "field.webp"; 
assets.forest.src = "forest.png";
assets.backforest.src = "backforest.png";
assets.grassLeft = new Image();
assets.grassRight = new Image();
assets.grassLeft.src = "grass.webp";
assets.grassRight.src = "grass.webp";
assets.secondGrassLeft = new Image();
assets.secondGrassRight = new Image();
assets.secondGrassLeft.src = "secondgrass.webp";
assets.secondGrassRight.src = "secondgrass.webp";
...
assets.picket.src = "picket.png"; 
assets.pedalClutchBrake.src = "pedal1.png";
assets.pedalGas.src = "pedal2.png";
assets.pole.src = "pole.png";
assets.windowGlass.src = "window.png";
assets.windowButtonHandle1.src = "handle.png";
assets.windowButtonHandle2.src = "handle2.png";
assets.windowButton = assets.windowButtonHandle1;
assets.handleMirror.src = "handlemirror.png";
assets.button1.src = "controls/button1.png";
assets.button2.src = "controls/button2.png";
assets.interiorLight.src = "interiorlighten.png";
assets.bird1.src = "bird.png";
assets.bird2.src = "bird2.png";
assets.radio.src = "radio.png"; 
assets.wiper.src = "wiper.png";
assets.counterl.src = "controls/counterl.png";
assets.counterHud.src = "controls/counterhud.png";
assets.counterNeedle.src = "controls/counter_needle.png";
assets.mirror.src = "mirror1.png";
assets.mirror2.src = "mirror2.png";
assets.docObject.src = "doc.png";
assets.opponentBottom.src = "opponent_bottom.png";
assets.opponentTop.src = "opponent_top.png";
assets.c_cockpit.src = "c_cockpit.png";
assets.c_engine.src = "c_engine.png";
assets.c_trunk.src = "c_trunk.png";
assets.blinker.src = "blinker.png"; // <--- DODAJ TĘ LINIĘ
assets.wheelBase.src = "wheelbase.png";
assets.wheel.src = "wheel.png";
...
docOverlayImages.images[0].src = "document1.png";
docOverlayImages.images[1].src = "document2.png";
...
for (const name of specialBuildingNames) { const img = new Image(); img.src = `building${name}.webp`; assets.specialBuildingImages.push(img); }
for (let i = 1; i <= 3; i++) { const img = new Image(); img.src = `field${i}.webp`; assets.fieldImages.push(img); }
...
carImageFiles.forEach(file => { const img = new Image(); img.src = `${file}`; assets.cars.push(img); });
